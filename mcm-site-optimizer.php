...
define( 'MCM_OPTIMIZER_VERSION', '1.8.2' );
...
require_once MCM_OPTIMIZER_DIR . 'includes/class-token-link-guard.php';
require_once MCM_OPTIMIZER_DIR . 'includes/class-upload-token-relay.php';
